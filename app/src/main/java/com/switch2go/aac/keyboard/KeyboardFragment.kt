package com.switch2go.aac.keyboard
...
import com.switch2go.aac.databinding.FragmentKeyboardBinding
import com.switch2go.aac.keyboard.adapter.KeyboardAdapter
...
class KeyboardFragment : BaseFragment<FragmentKeyboardBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Switch2GOTextToSpeech.isSpeaking.observe(viewLifecycleOwner, Observer {
