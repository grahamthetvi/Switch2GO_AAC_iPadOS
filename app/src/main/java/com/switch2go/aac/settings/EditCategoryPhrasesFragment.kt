...
import com.switch2go.aac.databinding.FragmentEditCategoryPhrasesBinding
...
import com.switch2go.aac.settings.customcategories.CustomCategoryPhraseListFragment
...
class EditCategoryPhrasesFragment : BaseFragment<FragmentEditCategoryPhrasesBinding>() {
    ...
    inner class PhrasesPagerAdapter(fm: FragmentManager) :
        Switch2GOFragmentStateAdapter<Phrase>(fm, viewLifecycleOwner.lifecycle) {
