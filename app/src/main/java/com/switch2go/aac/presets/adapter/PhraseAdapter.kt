package com.switch2go.aac.presets.adapter
...
import com.switch2go.aac.databinding.PhraseButtonAddBinding
import com.switch2go.aac.databinding.PhraseButtonBinding
import com.switch2go.aac.presets.PhraseGridItem
...
class PhraseAdapter(
    ...
    inner class PhraseGridItemViewHolder(itemView: View) :
        ...
        private fun applyPhraseStyle(button: Switch2GOPhraseButton, style: PhraseStyle) {
