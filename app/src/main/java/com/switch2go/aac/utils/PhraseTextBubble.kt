...
/**
 * Utility object for applying phrase styling (bubble text outline and images) to Switch2GOPhraseButton.
 */
object PhraseTextBubble {
     ...
     */
    fun apply(textView: Switch2GOPhraseButton, style: PhraseStyle?) {
     ...
     */
    fun clear(textView: Switch2GOPhraseButton) {
        textView.setTextOutline(null, null)
        textView.clearPhraseImage()
    }
}
