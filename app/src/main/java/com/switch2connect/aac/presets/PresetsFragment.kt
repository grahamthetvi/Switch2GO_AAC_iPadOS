...
import com.switch2connect.aac.customviews.PointerListener
import com.switch2connect.aac.customviews.VocablePhraseButton
import com.switch2connect.aac.databinding.FragmentPresetsBinding
import com.switch2connect.aac.eyegazetracking.EyeGazeTrackingViewModel
import com.switch2connect.aac.utils.SpokenText
import com.switch2connect.aac.utils.VocableFragmentStateAdapter
import com.switch2connect.aac.utils.VocableSharedPreferences
import com.switch2connect.aac.utils.VocableTextToSpeech
import com.switch2connect.aac.utils.PhraseTextBubble
...
class PresetsFragment : BaseFragment<FragmentPresetsBinding>() {
     ...
     */
    private fun applyPhraseStyle(button: VocablePhraseButton, style: com.switch2connect.aac.room.PhraseStyle) {
        val cornerRadius = 16f * resources.displayMetrics.density
        val selectedColor = ContextCompat.getColor(requireContext(), R.color.selectedColor)
