...
import com.willowtree.vocable.databinding.FragmentAdvancedEyeTrackingBinding
import com.willowtree.vocable.eyegazetracking.EyeGazeTrackingViewModel
import com.willowtree.vocable.eyegazetracking.EyeSelection
import com.willowtree.vocable.eyegazetracking.EyeTrackingMethod
import com.willowtree.vocable.eyegazetracking.SmoothingMode
...
class AdvancedEyeTrackingFragment : BaseFragment<FragmentAdvancedEyeTrackingBinding>() {
    ...
    private fun setupUI() {
        ...
        binding.trackingModeButton.action = {
            ...
            val modeString = if (newMethod == EyeTrackingMethod.TRACKING_3D) {
                VocableSharedPreferences.EYE_TRACKING_MODE_3D
            } else {
                VocableSharedPreferences.EYE_TRACKING_MODE_2D
            }
        ...
        val trackingMethod = if (savedMode == VocableSharedPreferences.EYE_TRACKING_MODE_3D) {
    ...
    private fun resetToDefaults() {
        ...
        sharedPrefs.setEyeTrackingMode(VocableSharedPreferences.EYE_TRACKING_MODE_2D)
        ...
        sharedPrefs.setEyeSelection(VocableSharedPreferences.EYE_SELECTION_BOTH)
        updateEyeSelectionButton(defaultEyeSelection)

        // Reset gaze amplification (default: 1.0x / Off)
        val defaultAmplification = VocableSharedPreferences.DEFAULT_GAZE_AMPLIFICATION
