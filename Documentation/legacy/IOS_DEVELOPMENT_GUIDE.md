> **Legacy bootstrap guide (obsolete for day-to-day work).** The iOS Xcode project is already in this repo. Use [iosApp/BUILD_AND_RUN.md](../../iosApp/BUILD_AND_RUN.md), [IOS_RELEASE_AND_SIGNING.md](../IOS_RELEASE_AND_SIGNING.md), and [TESTING_GUIDE.md](../../TESTING_GUIDE.md). See [README.md](README.md).
